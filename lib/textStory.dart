import 'textStructure.dart';

class TextGame {
  TextGame(this.textChapter);
 ...
 //RegExp exp3 = RegExp(r"[0-9]");
  ...
  int nextChapter(int textChapter)=>this.textChapter=textChapter;
  //номер главы
  int getChapterInt()=>_textBank[textChapter].numberChapter;
  
  
  //текст главы
  String getChapterString(){

    String noreplace = _textBank[textChapter].text;
    String replace = noreplace.replaceAll(exp, ' ');
    replace = replace.replaceAll(exp2, '');
    //replace = replace.//(exp3, 
    return replace;
    
    }
  
  //тут идут всe главы по возрастанию
  List<TextStructure> _textBank = [
    TextStructure(
        ...
        1),
    TextStructure('''
Знаю, что ты чертовски устал. Так отдохни немного. Это - приказ! Теперь чувствуешь себя лучше? Тогда ступай по тропинке, что взбирается на холм. Похоже, она ведет к
...
заслужил... Но что за треск в кустах? Узнаешь на 218. ''', 3),
    TextStructure('''Возможно, слух меня подвел, но мне  послышался  стон  из  тех  кустов 
...
осторожно отправляйся на 134 и выясни, кто там стонет! ''', 4),
    TextStructure('''Ты попал! Но если Роббин Гут тоже, то ты проиграл. Ты смотришь на его 

мишень. Ура! Он промахнулся! Счет равный:  два-два.  Соберись  и  стреляй! 

Окажешься на 343 или на 342. ''', 5),
    TextStructure('''- Стой! - хрипло орет стражник. - Кто идет? 
...
может, выхватишь меч? В этом случае ты - на 76. ''', 6),
    TextStructure('''Жизнь так редко дарит нам второй шанс. Вернись  на  94  и  хорошенько 

подумай. ''', 7),
    TextStructure('''Бредя по следам в пустыне, ты незаметно для себя  оказываешься  среди 
...
НЕТ ВОЗВРАТА. ПОМНИ, ТЫ МОЖЕШЬ СТАТЬ СЛЕДУЮЩИМ! 
     ...
     Песок под тобой проседает, и ты падаешь на 253. ''', 8),
    TextStructure('''Опять попал!  Победа!  И  не  просто  победа,  а  победа  всухую!  Со 

счастливой улыбкой ты переносишься на 311. ''', 9),
    TextStructure('''Проф нажимает на спусковой крючок, и ты получаешь в лицо облако газа. 

У тебя кружится голова, и ты без чувств падаешь на 82. ''', 10),
    TextStructure('''У тебя есть еще три золотые монеты! Ура! Ты трясущейся от  нетерпения 
...
твоими глазами на 140. ''', 11),
    TextStructure('''К счастью, тебя услышали. Кто-то ломится сквозь  лес,  направляясь  к 
...
стороне выступить, так что скорее двигай на 65. ''', 12),
    TextStructure('''Ты достаешь стрелу, натягиваешь  тетиву,  внимательно  целишься  и... 

Монстр бросается на тебя! Ты стреляешь и переносишься на 88. ''', 13),
    TextStructure(''' А ты, оказывается, стреляный волк! Действительно, неизвестно, кто  на 
...
без сомнения, понравился. Отправляйся на 99. ''', 14),
    TextStructure('''Фрукты растут высоко, с  земли  их  не  достать.  Ты  взбираешься  на 
...
по тропинке к 113. ''', 15),
    TextStructure('''Ты торчишь у таверны уже битый час, а из нее так никто  и  не  вышел. 

Тебя мучит жажда, слух раздражают звон пивных кружек и веселое  пение.  Не 

мучайся, отправляйся в таверну на 139. ''', 16),
    TextStructure('''Ты ползешь по тоннелям уже не первый час. Хорошо, что ты не подвержен 
...
оказываешься на 115. ''', 17),
    TextStructure(''' Сознаюсь, попав в подобную переделку, я бы  тоже  вспотел.  А  может, 
...
пряжке, и ты - на 87. ''', 18),
    TextStructure('''Ты бредешь по широкому светлому тоннелю, и неприятности тебе вроде бы 
...
отправишься ли вверх на 124. Или пойдешь вниз на 49. 
 ...
 ''', 19),
    TextStructure(''' Заморил червячка? Вот и отлично. Отправляйся на перекресток  дорог  к 

339, а там уж решишь, в какую сторону шагать дальше. ''', 20),
    TextStructure('''Ты получаешь именно то, что заслужил, доверившись  Волосатому  Гарри. 
...
машину времени. Щелкни пальцами, и перенесешься во времени на 80. ''', 21),
    TextStructure('''Твой план принят. Что там принят - подхвачен с восторгом!  Все  рабы, 
...
замку на 34. ''', 22),
    TextStructure('''- Откуда я знаю, что тебе нужно? - спрашивает  Роббин  Гут.  Ты  тихо 
...
спиной, ты идешь к указанной им тропе и следуешь по ней на 340. ''', 23),
    TextStructure('''Над твоей головой - безоблачное голубое небо, под ногами -  желтый  в 
...
сторону, то на 302. ''', 24),
    TextStructure('''С чего это старушка так шарахнулась от тебя? У тебя  угрожающий  вид? 
...
Тогда ты - на 90. ''', 25),
    TextStructure('''Согласен, золотая монета - многовато за переправу через реку. Но  что 
...
веслом по голове... Боже, какая боль! Бултых! Ты за бортом на 205. ''', 26),
    TextStructure('''Ты промахнулся, а Роббин Гут попал. Не беда! Пока - ничья, один-один. 

Ты целишься, стреляешь,  и  стрела  со  свистом  рассекает  воздух,  а  ты 

оказываешься на 163. Или на 289. ''', 27),
    TextStructure('''Проиграв очередной бой, ты,  связанный,  лежишь  на  полу  в  подвале 

Зловонного  замка.  Но  тише,  сюда  кто-то  идет.  Стражники.  Они  грубо 

поднимают тебя на ноги и волокут в зал на 121. ''', 28),
    TextStructure('''Понимаю,  понимаю,  тебе  не  очень  приятно.  Поверь,   и   искренне 
...
раз воспользуйся дымовой гранатой и окажешься на 64. ''', 29),
    TextStructure('''Итак, хочешь ты того  или  нет,  но  в  соответствии  с  заданием  ты 
...
передатчик материи, а ты немедленно переносишься на 42. ''', 30),
    TextStructure('''Если ты ответил, что слон тут же вскарабкается на  ближайшую  пальму, 
...
то на 344. ''', 31),
    TextStructure('''Сержант заявляет о своих подозрениях, но Арбутнот, не растерявшись, с 
...
пути устранено, быстрее в замок на 118. ''', 32),
    TextStructure('''Говори громче, а то твои губы то и дело скрываются в болотной жиже, и 
...
на 12. ''', 33),
    TextStructure(''' Впереди показывается замок. Рабы стирают с лиц  счастливые  улыбки  и 
...
окованные железом ворота, и ты с рабами - на 118. ''', 34),
    TextStructure('''Проф опять перехитрил тебя. Оказывается, он затаился за дверью, и как 
...
обнаруживаешь, что тебя занесло на 197. ''', 35),
    TextStructure('''Ты, никак, рехнулся?! Пулей лети на 120!''', 36),
    TextStructure('''Ты следуешь за профом из тронного зала, но судьба вновь немилостива к 
...
на 18. ''', 37),
    TextStructure('''- Благородный Сир, - говорит тебе юноша. - Приятно, что хоть  кому-то 
...
затем по ней к 216. ''', 38),
    TextStructure('''Ты  бежишь,  обливаясь  потом,  коридору  не  видно  конца,   повсюду 
...
тебе! Ползи за ним на 255. ''', 39),
    TextStructure('''Ты промахнулся, не попав даже  в  дерево.  Ты  переводишь  взгляд  на 
...
ты? Узнаешь на 254. Или на 284. ''', 40),
    TextStructure('''В ответ на твою просьбу Сейди кивает. - Ты прав, чужак.  В  Эндсвилле 
...
"утреннюю звезду", то на 54. Если же "дымовые гранаты", то на 50. ''', 41),
    TextStructure('''Вот мы и на солнечной Скралдеспенде. Что значит: "здесь жуткий  ветер 
...
Гроаннсвилль. Двигай туда на 62. ''', 42),
    TextStructure('''Ты совершил ошибку. Склон слишком скользкий и  крутой,  на  берег  по 

нему не выкарабкаться.  Выбора  нет,  плыви  к  дальнему,  но  пологому  и 

песчаному берегу 63. ''', 43),
    TextStructure('''Роббин Гут с удовольствием наблюдает, как ты, швырнув на землю лук, с 
...
вопрос разъяснится на 23. ''', 44),
    TextStructure('''Одумайся, новобранец! Разве полевой  агент  Спецкорпуса  лишит  жизни 
...
отбываешь на 215. ''', 45),
    TextStructure('''А надзиратель-то оказался вполне  приличным  человеком.  Он  сообщил: 
...
на перекресток 339, а там уж решишь, в какую сторону двигаться. ''', 46),
    TextStructure('''Не без основания боясь поскользнуться,  ты  медленно  спускаешься  по 
...
Пол под тобой расходится, и ты падаешь, падаешь, падаешь, до самой 98. ''', 47),
    TextStructure('''Мрачно, сумрачно, вокруг  темный,  дремучий  лес...  Что-то  мне  это 
...
Роберт Фрост, то на 67. ''', 48),
    TextStructure('''По-моему, ты выбрал верный  путь.  Ведь  если  вспомнить,  почти  все 
...
- И ОКАЖЕТЕСЬ СНАРУЖИ. ПРИЯТНОГО ВАМ ПУТЕШЕСТВИЯ. 
     ...
     Или побредешь по тоннелю вдоль следов от колес на 337. ''', 49),
    TextStructure('''Ты, беззаботно насвистывая и помахивая сумкой с  дымовыми  гранатами, 
...
рукоять меча, ты смело поворачиваешь на 164. ''', 50),
    TextStructure('''Ты  победил!  Стражник  на  коленях  молит  тебя  о  пощаде:   -   О, 
...
разрубишь его на части, ты - на 45. ''', 51),
    TextStructure('''Ты поешь, вкладывая в песню всю душу. Неудивительно, ведь  от  успеха 
...
подошло к логическому концу. Отправляйся с триумфом на 307! ''', 52),
    TextStructure('''Что с того, что деревенька перед тобой напоминает  городскую  свалку? 
...
кто-нибудь выйдет, подойди к нему и узнай, где проф. ''', 53),
    TextStructure('''Ты, беззаботно насвистывая и вращая над  головой  "утреннюю  звезду", 
...
поворачиваешь на 71. ''', 54),
    TextStructure('''Перед тобой крутой подъем. Но ты не слабак, взберешься! Вот ты  и  на 
...
попадаешь на 206. ''', 55),
    TextStructure('''Удивляюсь, новобранец, как с такой дырявой головой  можно  попасть  в 
...
левый сапог! Теперь отправляйся на 11. ''', 56),
    TextStructure('''Впереди слышна частая дробь  шагов!  Ты  выбрал  верное  направление! 
...
головокружение, ты окажешься на 255. ''', 57),
    TextStructure('''На трибунах беснуется толпа, вопит, орет и швыряет  на  арену  пустые 
...
рванешь что есть сил, то на 160. ''', 58),
    TextStructure('''- В твоих жилах, не иначе, течет королевская кровь! - говорит  Роббин 
...
времени на 80.. ''', 59),
    TextStructure('''Отлично сработано! 
...
правую руку. Ее решение узнаешь на 91. ''', 60),
    TextStructure('''Видимо, поэзия  -  не  твой  конек.  Четверостишие  принадлежит  перу 

Фроста. Ну да ладно, полевой агент Корпуса не обязан быть докой в  древней 

литературе (хотя образование - дело не лишнее). Словом, отправляйся на 67. ''', 61),
    TextStructure('''Ну, что я говорил, неопытный и слегка напуганный новобранец? Вот мы и 
...
сокращенно МПИ-четыре; Что? Сейчас обьясню, как работает эта хитрая  машина.  С 
...
остаешься, то - к 99. ''', 62),
    TextStructure('''Благополучно выбравшись на  берег,  ты  отряхиваешь  с  себя  вонючие 

зеленые  водоросли  и  оглядываешься.  В  полумиле  от  тебя   приземлился 

воздушный шар. Беги к нему на 130, согреешься по дороге. ''', 63),
    TextStructure('''Ты отлично сработал. Не затворив дверь, стражник с криками мечется по 
...
ползи на 345. ''', 64),
    TextStructure('''Бой был жаркий, и твоя помощь пришлась кстати. Как только ты  кусаешь 
...
благородному Арбутноту рукой и отправляешься на 48. ''', 65),
    TextStructure('''Ты с комфортом спускаешься, стоя на  движущейся  ступеньке.  Проходит 
...
Приготовься! Прыгай на 181! ''', 66),
    TextStructure('''С поэзией мы разобрались, ты оказался прав, но лес по-прежнему мрачен 
...
что ты вооружен, выйдешь с раскрытым ножом в руке, то отправляйся на 146. ''', 67),
    TextStructure('''Ты поешь, вкладывая в песню всю душу. Неудивительно, ведь  от  успеха 
...
логическому концу. Отправляйся с триумфом на 307! ''', 68),
    TextStructure('''Ты громко взываешь о помощи, но роботы -  жалкие  трусы!  -  вопя  от 
...
желаешь знать, что дальше, немедленно отправляйся на 70. ''', 69),
    TextStructure('''Плохи твои дела! 
...
сотни световых лет от дома тебе написано на роду. 
     ...
     Что ж, посмотрим на 278, что у тебя получится. ''', 70),
    TextStructure('''Навстречу тебе выезжает ковбой на шестиногой лошади. 
...
разоружает тебя. Неужели тебе конец?! Узнаешь на 161. ''', 71),
    TextStructure('''А Сейди-Садистик не такая уж садистка, как о ней говорят.  Ты  видишь 
...
напоследок поверженного врага, удаляешься на 348. ''', 72),
    TextStructure('''Тропа вьется среди холмов, вокруг мрачные джунгли, из чащи  доносятся 
...
удар мечом в грудь. Что дальше, узнаешь на 320. ''', 74),
    TextStructure('''Гигант  оказался  гораздо  проворнее,  чем  ты  предполагал.   Грязно 
...
Если желаешь знать, что дальше, смотри на 70. ''', 75),
    TextStructure('''Отлично сработано! 
...
отбываешь на 78. ''', 77),
    TextStructure('''- Благодарю, о, могучий и благородный чужестранец! - скрипит робот. - 
...
противоположному концу моста на 128. ''', 78),
    TextStructure('''Полагая, что с тобой кончено, стражник с победным воплем кидается  на 

тебя, но ты бьешь его обеими ногами в грудь. Он падает на край  моста,  ты 

приставляешь острие меча к его горлу, и вы оба переноситесь на 51. ''', 79),
    TextStructure('''Ты вновь под виселицами среди преступников,  алчущих  твоего  золота. 
...
преступнику, и не раньше. ''', 80),
    TextStructure('''Ничего хорошего не получилось! 
...
51. ''', 81),
    TextStructure('''Сознание возвращается к тебе, и ты с горечью  обнаруживаешь,  что  на 
...
проходишь через чердачную дверь, оказываясь на 148. ''', 82),
    TextStructure('''И ты  называешь  себя  новобранцем  Специального  Корпуса?  Разве  не 

слышишь жалобных стонов старика? 

     Ну-ка возвращайся в таверну на 170 и швыряй в громил гранату! ''', 83),
    TextStructure('''Ты опять попал, а твой соперник промахнулся! Счет - два ноль  в  твою 

пользу! А он не такой уж хороший стрелок, как хвастал! 

     Вы вновь стреляете и оказываетесь либо на 166, либо на 9. ''', 84),
    TextStructure('''Если ты сказал, что на сосне сидит ворона с автоматом,  то  получаешь 
...
маленькая серая мышка? 
     ...
     Хорошенько подумав, отправляйся на 31. ''', 85),
    TextStructure('''Ты взобрался на стену. Оглядись. Никого? 
...
старушке, то на 25. ''', 86),
    TextStructure('''До чего же мастерски ты  пнул  двух  громил  ногами,  с  которых  они 
...
смелей же прыгай вниз на 306. ''', 87),
    TextStructure('''Великолепный выстрел!  Прямо  в  Зеленый  Пупок!  Бездыханный  монстр 
...
лицу на 131? ''', 88),
    TextStructure('''Звездному  чудищу  забава  пока  не  наскучила,  и  оно  задает  тебе 
...
Н2SО4. Что было в склянке? Думай быстрей, отвечай и двигай на 1. ''', 89),
    TextStructure('''Взятка вроде сделала свое дело. Указания достаточно  ясны:  дойти  до 
...
ребра, удаляешься на 348. ''', 91),
    TextStructure('''Впереди показалась деревенька. Похоже, ты на  верном  пути,  и  перед 
...
вернешься к перекрестку и направишься по другой дороге? Тогда ты - на 53. ''', 92),
    TextStructure('''Ты  падаешь  на  мягкий  пыльный  матрас.   Клубы   пыли   постепенно 
...
тебя в идиота, и попробуешь песочный торт, то ты на 158. ''', 93),
    TextStructure('''Бой был жаркий, и твоя помощь пришлась кстати. Как только ты  кусаешь 
...
7. ''', 94),
    TextStructure('''Ты выскакиваешь на  крошечный  балкончик.  Оказывается,  по  винтовой 
...
поделаешь, такова полная трудностей жизнь полевого агента. 
     ...
     Карабкайся, не опуская глаз, пока не спустишься на 255. ''', 95),
    TextStructure('''С трудом переставляя  ноги,  ты  входишь  в  древний  лабиринт.  Тебя 
...
раз видел в космопортах, 66. Куда направишься? Решай живее! ''', 96),
    TextStructure('''Старик хоть и выглядит настороженным, но, увидев  тебя  с  посохом  в 
...
Можно ли верить хоть кому-нибудь на планете-тюрьме? 
     ...
     Если по западной, то на 129. ''', 97),
    TextStructure('''Ты - в  огромном  наклонном  желобе,  по  которому  струится  грязная 
...
- твой единственный шанс на спасение! 
     ...
     Прыгай на 181! ''', 98),
    TextStructure('''Все мы совершаем ошибки. 
...
Возьми один. 
     ...
     Если орел, к 189. ''', 99),
    TextStructure('''Ты берешь сеть в левую руку, трезубец в  правую;  дверь  перед  тобой 

распахивается, в глаза бьет яркий солнечный свет. Ты распрямляешь спину и, 

гордо подняв подбородок, выходишь на 58. ''', 100),
    TextStructure('''Ну и что с того, что он пнул тебя ногой в коленную чашечку, едва ты с 
...
не попадешь на 20. ''', 101),
    TextStructure('''Ты попадаешь в светлую чистую комнату. Посередине стоит стол, рядом с 
...
Сейди Садистик по коридору к 109. ''', 102),
    TextStructure('''Дракон  за  твоей  спиной,  взвыв,  изрыгает  струю  пламени,  и  ты, 
...
221. ''', 103),
    TextStructure('''Тропа расширяется, ты идешь по ней, бодро  насвистывая  песенку.  Еще 
...
- на 155. ''', 104),
    TextStructure('''Скользить по шесту вниз несложно и  даже  приятно.  Но  когда  же  он 
...
181! ''', 105),
    TextStructure('''Уж не везет, так не везет. Тебе, как назло, попалась дымовая граната. 
...
потасовка. Кажется, они друг друга стоят. 
     ...
     Если незнакомому громиле, то на 65. ''', 106),
    TextStructure(''' Уже в самом низу ты кое-как сумел замедлить падение. Вокруг -  вязкое 
...
грязи красавцем? ''', 107),
    TextStructure('''Ты попытался обойти кабана, но не смог. Что  ж,  отдохни  немного,  а 

потом подберись к деревьям на 110 и понаблюдай за животным. ''', 108),
    TextStructure('''- Выдайте добровольцу оружие и экипировку! - распоряжается Сейди. 
...
джунгли 125. ''', 109),
    TextStructure('''Господи! Столь омерзительного создания не увидишь даже  после  дюжины 

бокалов Специального Альтаирского! 

     Кабанище плещется в грязи и  громко  булькает.  Незаметно  подойди  к 

следующему дереву на 207 и присмотрись к нему повнимательнее. ''', 110),
    TextStructure('''Ты бредешь, с трудом выдергивая ноги из трясины. С  каждым  шагом 
...
над болотом возвышается холм. 
     ...
     Если сумеешь дойти до него, окажешься на 108. ''', 111),
    TextStructure('''Хищник вновь промахнулся. Но, согласен, хотя  он  и  слегка  неуклюж, 
...
зрачки хищника до самой 305. ''', 112),
    TextStructure('''Тропинка петляет по джунглям, твоя спина  все  больше  сгибается  под 
...
берет тебя за шиворот, сажает на спину, взлетает и устремляется к 199. ''', 113),
    TextStructure('''Понимаю, тебе досталось, и ты рассержен на  жестоких  охранников.  Но 
...
людьми. Поговори с одним из них. 
     ...
     Если к старушке, то на 25. ''', 114),
    TextStructure('''Ты попадаешь в вырубленную в скале комнату, но прежде  чем  успеваешь 
...
вымершей расой. 
     ...
     Ничего не поделаешь, придется тебе еще раз войти в него на 96. ''', 115),
    TextStructure('''Навстречу тебе идет закованный в латы громила. Латы  примитивные, 
...
лежишь полуоглушенный и беспомощный. 
     ...
     Узнаешь на 185. ''', 116),
    TextStructure('''Ты с трудом поворачиваешь  голову  птицы  Рок  так,  чтобы  клюв  был 
...
142. ''', 117),
    TextStructure('''Пройдя с рабами по  длинным  коридорам  Зловонного  замка,  ты  вновь 
...
которую кто-то позабыл в углу, то на 120. ''', 118),
    TextStructure('''Ты поворачиваешь ручку, плечом надавливаешь на дверь, она  с  щелчком 
...
меча, то ты - на 165. ''', 119),
    TextStructure('''Удар! Бах-ба-бах! Дверь рассыпается в щепки! 
...
руке бросаешься в коридор. 
     ...
     Не стой же, как истукан! Действуй! ''', 120),
    TextStructure('''Перед тобой на троне из человеческих костей восседает Волосатый Гарри 
...
смертельно опасном опыте. 
     ...
     Если решка, в печь на 18. ''', 121),
    TextStructure('''Ты допрыгиваешь, но тонкий слой  застывшей  лавы  под  твоими  ногами 
...
скалу, ругаясь, когда из-под ноги вылетает камень. 
     ...
     Быстрей полезай в него! ''', 122),
    TextStructure('''Из тоннеля доносится ужасная вонь. Набери в легкие побольше воздуха и 
...
отправишься дальше, подкинь ДОСП. 
     ...
     Если решка, правым на 17. ''', 123),
    TextStructure('''Действительно,  зачем  древним  врать?  Ты   медленно   и   осторожно 
...
ОКАЖЕТЕСЬ СНАРУЖИ. ПРИЯТНОГО ПУТЕШЕСТВИЯ. 
     ...
     Или побредешь по тоннелю вдоль следов от колес на 337. ''', 124),
    TextStructure('''Несмотря на солнечный день, здесь царит мрачный полумрак. Но это тебя 
...
нужном направлении, к руинам. 
     ...
     Если правую, то на 55. ''', 125),
    TextStructure('''Бывает, что не ладится все, что бы ни предпринял. Вот и сейчас прежде 

чем ты добираешься  до  низа  корзины,  проф  перерезает  веревку,  и  ты, 

отчаянно вопя, падаешь к 136. ''', 126),
    TextStructure('''Найдя в кустах надежное убежище, ты  сооружаешь  из  травы  и  цветов 
...
и идешь к мосту на 252. ''', 127),
    TextStructure('''Перейдя через мост, ты обнаруживаешь, что тебя в очередной раз надули 
...
стрел многочисленных врагов. 
     ...
     А если, прежде чем прыгнешь вниз, снимешь кольчугу, то на 271. ''', 128),
    TextStructure('''Дороге не видно конца. Пыльно, жарко, но ты настойчив  и  бесстрашен, 

так что продолжай путь. 

     Выбора у тебя нет: шагай, покуда не окажешься на 180. ''', 129),
    TextStructure('''Чем ближе ты к воздушному шару, тем медленнее твой бег. 
...
черным пистолетом. 
     ...
     Если слева, то на 192. ''', 130),
    TextStructure('''Перед тобой одетый во все зеленое высокий незнакомец. Он трясет рукой 
...
дальше, узнаешь на 257. Или на 40. ''', 131),
    TextStructure('''- Хочешь получить информацию задарма? - ревет  верзила.  -  За  такую 
...
вскрикивает и бросается наутек. 
     ...
     Выругавшись, ты идешь по дороге дальше, пока не попадаешь на 190. ''', 132),
    TextStructure('''Ты промахнулся, а твой соперник, к  сожалению,  попал.  Счет  равный, 

два-два. 

     Не вешай голову, соберись и стреляй! 

     Окажешься на 343 или на 342. ''', 133),
    TextStructure('''Юноша привалился спиной к стволу дерева, его левая нога вывернута под 
...
на 38. ''', 134),
    TextStructure('''Из последних сил ты доплываешь до берега, вылезаешь из воды и пластом 
...
смертельно опасный монстр Зеленый Пупок. 
     ...
     Если же выстрелишь в него из лука, то на 13. ''', 135),
    TextStructure('''Ты падаешь, падаешь... Нет-нет, и не  надейся.  Под  тобой  вовсе  не 
...
берегу 43. 
     ...
     Или к дальнему, но пологому песчаному правому 63. ''', 136),
    TextStructure('''С чего это парнишка так шарахнулся от тебя? У  тебя  угрожающий  вид? 
...
информацию? Тогда ты - на 90''', 137),
    TextStructure('''Беги как можно быстрей на 4! 

     Оставаться на месте - смертельная ошибка''', 138),
    TextStructure('''Настороженно озираясь, ты входишь в таверну.  Видишь,  как  у  стойки 
...
ухмыляясь и помахивая дубинками, наступают на тебя. 
     ...
     Если швырнешь в громил гранату с сонным газом, то на 170. ''', 139),
    TextStructure('''Поздний вечер, ты сидишь под виселицами, сова на ближайшем надгробном 
...
жука. Отлично сделано! Теперь жди рассвета. 
     ...
     Ты засыпаешь, а просыпаешься уже на 179. ''', 140),
    TextStructure('''Прием отлично сработал на арене, сработает  и  здесь.  Ты  пристально 
...
там, прими другое, более мудрое решение! ''', 141),
    TextStructure(''' Ты  захлопываешь  за  спиной  дверь.  Как  раз   вовремя!   Башня   с 
...
беги к 171. ''', 142),
    TextStructure('''У тебя сильные мускулистые руки, но мышцы устали, пальцы скользят  по 
...
на 136. 
     ...
     Если судорожно поползешь по веревке вверх, к корзине, то на 126. ''', 143),
    TextStructure(''' На трибунах беснуется толпа, вопит, орет,  швыряет  на  арену  пустые 
...
то ты - на 282. 
     ...
     Если увернешься и обрушишь на противника меч и щит, то на 60. ''', 144),
    TextStructure('''Согласен, в тяжелой кольчуге с  вооружением  под  обжигающими  лучами 
...
108. ''', 145),
    TextStructure('''Ты до сих пор так и не понял, что насилием ничего не добьешься? 
...
успехом пользоваться. 
     ...
     Если по западной, то на 129. ''', 146),
    TextStructure('''Сейди сует в  твою  ладонь  десять  золотых  монет  и  показывает  на 
...
поблагодарив ее за доброту. ''', 147),
    TextStructure('''Преследуя профа по длиннющим коридорам и широченным залам  замка,  ты 
...
ветра твои руки деревенеют. 
     ...
     Похоже, твоим мучениям придет конец лишь на 143. ''', 148),
    TextStructure('''Со слезами на глазах, Арбутнот обнимает тебя за  плечо  и  уводит  от 
...
твоего указательного пальца правой руки машину времени. 
     ...
     Щелкни пальцами, и перенесешься во времени на 80. ''', 149),
    TextStructure('''Похоже, надпись в очередной раз  обманула  тебя  -  ты  прошел  через 
...
Джунглей. 
     ...
     Открывай же дверь и смело иди на 119. ''', 150),
    TextStructure('''Узнав от твоем решении, роботы воют от горя, целуют твои руки,  молят 
...
270. ''', 151),
    TextStructure('''Согласен, щекотать хищника - не слишком  эффективная  идея.  Животное 

просто отшвырнуло  тебя  ударом  лапищи  и  теперь,  приблизившись,  вновь 

готовится к прыжку. 

     Самое время отпрыгнуть на 112. ''', 152),
    TextStructure(''' Мог бы перелезть через стены и в другом месте, получше! 
...
слева, справа, спереди, сзади. 
     ...
     В сознание ты приходишь уже на 28. ''', 153),
    TextStructure('''Верзила хмуро глядит на тебя из-под косматых бровей, ты отвечаешь ему 
...
через плечо, шагаешь по тропинке к 113. ''', 155),
    TextStructure('''Ты слышишь глухой удар. Волосатый Гарри, взревев от  боли,  отпускает 
...
на 21. ''', 156),
    TextStructure('''Меч против дубины - у тебя  неплохие  шансы  на  победу.  Но  тут  же 
...
выбивает меч из твоей руки. 
     ...
     Или, может, позовешь с 69 на помощь роботов? ''', 157),
    TextStructure('''На вкус - очень даже недурственно. Видимо, проф  солгал  тебе.  Ты  с 

аппетитом доедаешь песочный торт, а затем принимаешься  за  шоколадный  и, 

одолев его, поворачиваешься к дракону на 299. ''', 158),
    TextStructure('''Сейди, лучезарно улыбаясь, ведет тебя в лес. 
...
перенесешься во времени на 80. ''', 159),
    TextStructure('''Отлично сработано! 
...
медленно поднимает правую руку. 
     ...
     Ее решение узнаешь на 72. ''', 160),
    TextStructure('''Ковбой, обыскав  тебя,  выбрасывает  передатчик  материи,  так  и  не 
...
328. ''', 161),
    TextStructure('''О, КАКОЙ УЖАС! 

     Место, куда тебя занесло, столь  чудовищно,  что  даже  не  поддается 

описанию. 

     Быстрее возвращайся туда, откуда прибыл! ''', 162),
    TextStructure('''Промахнулся. А Роббин Гут? Он попал. Н-да, и счет: один-два не в твою 

пользу. Но расслабься! Спокойно целься и стреляй, окажешься на  5  или  на 

342. ''', 163),
    TextStructure('''Навстречу тебе попадается безобразный детина - все тело в шрамах,  на 
...
беспомощный. 
     ...
     Узнаешь на 329. ''', 164),
    TextStructure(''' Едва ты притрагиваешься острием меча  к  рубину,  как  слышишь  тихое 
...
308. ''', 165),
    TextStructure('''Промахнулся. А Роббин Гут? Он попал. Но не страшно, счет - два один в 

твою пользу. Спокойно целься и стреляй, окажешься на 133 или на 343. ''', 166),
    TextStructure('''Постепенно вживаешься в роль? Становишься садистом? 
...
"Хестелорт". Но веришь ли ты указателям? 
     ...
     Если нет, то на 53. ''', 167),
    TextStructure('''Все пятеро обманули тебя? Ты вновь стоишь среди них.  К  счастью,  им 
...
ближе! 
     ...
     Что предстало твоим глазам, узнаешь на 323. ''', 168),
    TextStructure('''Приятный для прогулки денек - над головой сияет солнце, в ветвях мило 
...
держись от замка подальше! 
     ...
     - Если так, то, благородный юноша, отправляйся на 214. И удачи тебе! ''', 170),
    TextStructure('''Не дерись с хищником, а используй в борьбе мозги! 
...
косматая бестия подойдет ближе... Пора! Двигай к 213. ''', 171),
    TextStructure('''Ты бежишь от монстра, и я не виню тебя. Перед твоими глазами мелькают 

кусты, деревья, ты взбираешься  на  холм,  спускаешься  с  него,  огибаешь 

другой... Глаза твои зали��ает пот, каждый вдох дается с великим трудом. Ты 
...
стреляешь и переносишься на 88''', 172),
    TextStructure(''' Ты берешь щит в левую  руку,  меч  -  в  правую;  дверь  перед  тобой 

распахивается, в глаза бьет яркий солнечный свет. Ты распрямляешь спину и, 

гордо подняв подбородок, выходишь на 144. ''', 173),
    TextStructure('''Смотри-ка, походная  кухня,  вокруг  нее  суетятся  роботы,  а  рядом 
...
спросить приятного мужчину впереди себя, где находится Гроаннсвилль? 
     ...
     Если нет, то стой в очереди, пока не попадешь на 20. ''', 174),
    TextStructure('''Ты так ничему и не научился! Впредь держись подальше от жителей  этой 
...
замочную скважину ключ. 
     ...
     Доставай гранату с сонным газом и отправляйся на 29. ''', 175),
    TextStructure('''Ты чертовски устал, а дороге не видно конца. Ноги  у  тебя  буквально 

отваливаются; зевая, ты идешь, пока не оказываешься на 190. ''', 176),
    TextStructure('''Удар лапищи хищника, и ты отлетаешь в один угол комнаты, твой меч - в 
...
длиннющим хвостом, вновь приближается. 
     ...
     Отлично, тогда быстрее к 171. ''', 177),
    TextStructure('''Доски под твоими ногами скрипят, грозя рухнуть в любую  секунду.  Иди 
...
не пристало орать так громко, даже падая в реку Гремучих Змей! 
     ...
     Ты - на 205. ''', 178),
    TextStructure('''Просыпаешься ты от сильнейшего удара в скулу. Прокатившись по  земле, 
...
острыми, как иглы, зубами, ты дергаешься, но убежать не в силах. 
     ...
     Узнаешь на 156''', 179),
    TextStructure('''Все так же жарко и  пыльно,  но  у  тебя,  видимо,  открылось  второе 
...
тогда сразу очутишься на 46. ''', 180),
    TextStructure('''Ты приземляешься посреди крошечного островка и, хотя  скользишь,  но, 
...
лава. 
     ...
     Или к подножию правой на 122. ''', 181),
    TextStructure('''Ты бежишь, но парни не отстают, вот-вот догонят. 

     Ты, подобно загнанному в угол зверю, разворачиваешься, и на 194 между 

вами разгорается жаркая схватка. ''', 182),
    TextStructure('''Твоя уловка  сработала,  волк  прыгнул,  но  ты  вовремя  отступил  в 

сторону, и он промахнулся. Но он вновь приближается! 

     Самое время отпрыгнуть на 112. ''', 183),
    TextStructure('''Ты попал, а соперник промахнулся! Правда, счет пока - два-один  не  в 

твою пользу. Расслабься! Спокойно целься и стреляй, окажешься на 5 или  на 

342. ''', 184),
    TextStructure('''Рыцарь, обыскав тебя, отбрасывает на дорогу передатчик материи, так и 
...
328. ''', 185),
    TextStructure('''Становится темно - похоже, приближается  гроза.  Холодно,  ветрено  и 
...
на 33. ''', 186),
    TextStructure('''Знаешь, похоже, твое истинное призвание - подмостки. 
...
ты отправляешься по тропинке к 104. ''', 187),
    TextStructure('''Ты попал в длиннющий пыльный коридор, из щелей в его стенах и потолке 
...
надписи врут. В какую дверь пойдешь? 
     ...
     Если решка, то в правую на 150. ''', 188),
    TextStructure(''' Уж не везет, так не везет. Тебе попалась граната с сонным  газом,  но 
...
потасовка. Как видно, они стоят друг друга. 
     ...
     Если незнакомому громиле, то на 65. ''', 189),
    TextStructure('''Ты слышишь позади себя быстрые шаги по булыжнику. 
...
на дороге появляются парни, одетые в черные кожаные куртки. 
     ...
     Либо останься на 194 и прими бой. ''', 190),
    TextStructure('''Ты ползешь по тоннелю, но вскоре впереди появляется свет. 
...
протягиваешь к ручке дрожащие пальцы, хватаешься за нее, дергаешь и... 
     ...
     Пол под тобой расходится, и ты падаешь, падаешь, падаешь до самой 98. ''', 191),
    TextStructure('''Затаив дыхание, ты крадешься вокруг шара. Эх, если бы  в  твоей  руке 
...
песке свежие отпечатки подошв. 
     ...
     Следуй за ним на 225. ''', 192),
    TextStructure('''Что это там впереди? 
...
вооруженные стражники. 
     ...
     Или попытаешься перелезть через городскую стену 86. ''', 193),
    TextStructure('''Ты силен и храбр, но ты устал. Кожаные парни окружают тебя и  сбивают 
...
кожаные волокут тебя к 334. ''', 194),
    TextStructure(''' Ты хватаешь стрелу, натягиваешь тетиву, целишься и... 

     Монстр бросается на тебя! 

     Ты стреляешь и переносишься на 88. ''', 195),
    TextStructure('''Да ты, оказывается, не только  отличный  пловец,  но  и  превосходный 
...
прошли для тебя даром. 
     ...
     Правильно, дождавшись темноты, перелезь через стену, и ты - на 153. ''', 196),
    TextStructure('''Ты слышишь топот убегающих шагов в тоннеле. Позабыл о  задании?  Беги 

же быстрей за профом на 242! ''', 197),
    TextStructure('''Тебе пришлось нелегко, но ты справился. Знай же, я горжусь тобой! 
...
Процессов и выяснить свою дальнейшую судьбу. 
     ...
     Если решка, то на 196. ''', 198),
    TextStructure('''Этот полет ты не забудешь до конца своих дней! 
...
выбор определит случай. Подбрось ДОСП. 
     ...
     Если решка, к правой на 327. ''', 199),
    TextStructure('''Не теряй напрасно времени, ведь и дураку ясно, что что  указатели  на 

перекрестке были перевернуты и ты попал вовсе не туда, куда надо. 

     Сейчас же беги на 53. ''', 200),
    TextStructure('''- Начало, и неплохое, положено,  -  говорит  звездное  чудище.  -  За 

верный ответ - десять очков. Посмотрим, как  ты  справишься  с  остальными 

вопросами. Кто черный, смертельно опасный сидит на сосне? 

     Знаешь ли ты ответ или нет, отправляйся на 85. ''', 201),
    TextStructure('''Ты на дне глубоченной  ямы,  высоко  над  тобой  крошечный  квадратик 
...
дыхание. 
     ...
     Или к другой на юг 210? ''', 202),
    TextStructure('''Неужели ты столкнулся с  очередной  иллюзией,  вызванной  механизмами 
...
скалу, ругаешься, когда из-под ног летят камни. 
     ...
     Рядом с тобой в скале вход в тоннель 333. Быстрей полезай в него! ''', 204),
    TextStructure('''Хорошо, что ты отличный пловец. Но смотри! 
...
выберешься на крутой, каменистый, но зато голый, как колено, берег? 
     ...
     Или поспешишь к грозящему неизвестными опасностями берегу 3? ''', 205),
    TextStructure('''Тропа все  поднимается  и  поднимается;  следуя  по  ней,  ты  вскоре 

забираешься на гребень крутого холма, и... 

     Споткнувшись, ты летишь вниз к 107. ''', 206),
    TextStructure('''Кончай ковырять пальцем в ухе и трясти головой! 
...
дуэтом на 266? ''', 207),
    TextStructure('''Наконец-то! Ты перелезаешь через полуобвалившуюся стену и выбираешься 
...
следов за безумным профом. 
     ...
     Следы приводят тебя к 261. ''', 208),
    TextStructure(''' Ты счастливчик! 

     Сейди-Садистик выставляет правую руку,  ее  большой  палец  направлен 

вверх. Всхлипывая, ты отправляешься на 348. ''', 209),
    TextStructure('''Люди порой ошибаются. Даже я. 
...
202. ''', 210),
    TextStructure(''' Господи, до чего удивительные  звери  нарисованы  на  стенах  в  этой 
...
творили чудеса! 
     ...
     Решай быстрей! ''', 211),
    TextStructure('''Ты ударяешься головой о низкий потолок и,  придя  в  себя,  потерянно 
...
комнату. Оказывается, отсюда два выхода. 
     ...
     Поспеши выбраться через любой! ''', 212),
    TextStructure('''Ты рывком распахиваешь дверь и отступаешь в сторону. На  крысольва  с 
...
смело шагай через нее на 188. ''', 213),
    TextStructure('''Хорошенько закусив и выпив в таверне, ты снова бредешь по дороге. Вот 
...
26. 
     ...
     Если на свой страх и риск воспользуешься хлипким мостом, то на 178''', 214),
    TextStructure('''- Благодарю, о, могучий и благородный чужестранец! -  хрипло  говорит 
...
противоположному концу моста на 128. ''', 215),
    TextStructure('''Ты догоняешь колонну рабов, скованных массивной цепью. 
...
решение, оказываешься на 22. ''', 216),
    TextStructure('''Да, мне тоже не по душе наполненная едким, сизым дымом и  пропитанная 
...
попал сюда. 
     ...
     Ничего не поделаешь, возвращайся на запад к 300. ''', 217),
    TextStructure('''Громилы! Да как много! 
...
ты приходишь уже на 28. ''', 218),
    TextStructure('''Рекрут, клянусь, ты мне нравишься! 
...
и проследуешь на 266? ''', 219),
    TextStructure('''Удивительно, каких высот достигла наука древней расы! 
...
улыбкой на устах ты бродишь по долине и выясняешь, что отсюда три выхода. 
     ...
     С тоскою в сердце ты отправляешься выполнять задание. ''', 220),
    TextStructure('''На вкус - очень даже недурственно. Видимо, проф  солгал  тебе.  Ты  с 

аппетитом доедаешь шоколадный торт, а затем принимаешься  за  песочный  и, 

одолев его поворачиваешься к дракону на 299 ''', 221),
    TextStructure('''В кромешной тьме ты сваливаешься  в  воду.  Вода  какая-то  странная, 
...
помещение посуше. 
     ...
     Либо на юг к 235. ''', 222),
    TextStructure(''' Набрался сил? 

     Ну, судьба не ждет, отправляйся за профом в лабиринт на 96. ''', 223),
    TextStructure('''Громадный толстый кабан, не пропустив ни единой ноты, опрокинул  тебя 
...
борова? 
     ...
     Тогда увернись от него и сразу попадешь на 219. ''', 224),
    TextStructure(''' Следы уходят за горизонт. Ты устал, но упорно бредешь  и  бредешь  по 
...
на 223. ''', 225),
    TextStructure('''Темная комнатенка. Скорее даже не  комнатенка,  а  чулан.  Ты  быстро 
...
нащупываешь три двери с ручками. 
     ...
     Ты поворачиваешь ручку, распахиваешь ближайшую дверь и выходишь. ''', 226),
    TextStructure('''Огромный зал с величественными колоннами, подпирающими высокий резной 
...
по залу, ты находишь три двери. 
     ...
     Боясь, что обвалится потолок, ты спешишь. ''', 227),
    TextStructure('''Надо же, вода выливается из  небольшого  отверстия  под  потолкам,  а 

выход из комнаты только один. 

     Возвращайся на запад к 222. ''', 228),
    TextStructure('''Утомленное непривычно долгим разговором звездное чудище повалилось на 
...
будешь стоять, разинув рот, то на 197. ''', 229),
    TextStructure('''Ты бежишь от монстра, и я не виню тебя. Перед твоими глазами мелькают 
...
стреляешь и переносишься на 88. ''', 230),
    TextStructure('''Атакуешь! Прыгаешь прямо на пистолет! Да ты,  оказывается,  смельчак! 
...
падаешь на 82. ''', 231),
    TextStructure(''' Отлично  сработано!  Стражник  по   инерции   проносится   мимо,   и, 
...
вверх. Всхлипывая, ты отправляешься на 348. ''', 233),
    TextStructure('''Ты попал в здоровенное,  наполненное  огромными  ржавыми  механизмами 
...
выхода. 
     ...
     И на восток к 241. ''', 234),
    TextStructure('''Ужасное место! В лицо летят подхваченные  порывами  ураганного  ветра 
...
колючие песчинки. 
     ...
     Быстрее выбирайся! ''', 235),
    TextStructure('''ОХ! АХ! КАКОЙ КОШМАР! 

     Быстрее туда, откуда попал сюда. ''', 236),
    TextStructure('''Не слишком удачный прием! 
...
на 79. ''', 237),
    TextStructure('''Ты попал в крошечную, увешанную паутиной и пропыленную каморку  всего 
...
241. ''', 238),
    TextStructure('''Ты в комнате с двумя дверями, из-за них доносятся приглушенные  крики 
...
решение своей судьбы. 
     ...
     Или с надписью "ВОЛКИ", тогда - на 318. ''', 239),
    TextStructure('''Ты абсолютно прав! Металлический пол в этой комнате красный именно от 
...
жара. 
     ...
     Или на юг к 212. ''', 240),
    TextStructure('''В этой комнате темно и чертовски холодно,  вокруг  покрытые  льдом  и 
...
обнаруживаешь три выхода. 
     ...
     Ты спешишь выбраться из царства холода через один из них. ''', 241),
    TextStructure('''Оставив наконец  за  спиной  мрачное  лежбище  звездного  чудища,  ты 
...
проф! 
     ...
     Не забывая об опасности, следуй за ним на 8. ''', 242),
    TextStructure('''Ты счастливчик! 

     Сейди-Садистик выставляет правую руку,  ее  большой  палец  направлен 

вверх. Всхлипывая, ты отправляешься на 348. ''', 243),
    TextStructure('''Пол в комнате мягкий, как перина. Так и хочется улечься  на  него.  К 
...
спать нет времени. 
     ...
     Или на восток к 295. ''', 244),
    TextStructure('''Солнце уже коснулось горизонта, а тропинке все нет конца. 
...
груди молот и вновь бросается на тебя. 
     ...
     Если по голове, то на 262. ''', 246),
    TextStructure('''Уф! До чего здесь приятно дышится после комнаты  с  воздухом-киселем. 
...
ты еще больше прибавляешь прыти. Ты беззаботен и счастлив, как вдр��г... 
...
комнаты с густым воздухом. ''', 247),
    TextStructure('''Ты вновь протягиваешь к рубину руку и вновь замираешь. 
...
и поддень рубин. А дальше - на 165. ''', 248),
    TextStructure('''Ты забираешься под куст и убеждаешься, что с  тропы  тебя  не  видно. 
...
Выходи, чужак! Я знаю, где ты! 
     ...
     Выбора у тебя нет, и, дрожа, ты вылезаешь из кустов на 131. ''', 249),
    TextStructure('''Полагая, что с тобой кончено, робот с победным  воплем  бросается  на 
...
приставляешь острие своего меча к его горлу, и вы оба переноситесь на 316. 
 ...
 ''', 250),
    TextStructure('''Ты в комнате, освещенной лишь тусклой вонючей свечкой. 
...
239. ''', 251),
    TextStructure('''- Стой! - хрипло орет робот. - Кто идет? 
     ...
     Или, может, выхватишь меч? В этом случае ты - на 246. ''', 252),
    TextStructure('''Ты падаешь на кучу песка посреди обширного, вырубленного в монолитной 
...
существует. 
     ...
     Или через южную на 227. ''', 253),
    TextStructure('''Классный выстрел! Ты поразил свою мишень в  самую  середину,  а  твой 
...
и вы одновременно выпускаете стрелы. 
     ...
     Или на 289. ''', 254),
    TextStructure('''Ты жив и ты на крыше. Размахивая над головой дубинкой, ты преследуешь 
...
Кхе-кхе-хе! 
     ...
     Если остановишься в нерешительности, то на 10. ''', 255),
    TextStructure('''  Затаив дыхание, ты крадешься вокруг шара. Эх, если бы  в  твоей  руке 
...
видишь на песке свежие отпечатки подошв. 
     ...
     Следуй за ним на 225. ''', 256),
    TextStructure('''Прекрасный выстрел! Ты поразил свою мишень в самую середину,  а  твой 
...
падаешь на 250. ''', 258),
    TextStructure(''' Попался, как мышь в мышеловку! 
...
попал. 
     ...
     Отправляйся назад на юг к 244. ''', 259),
    TextStructure('''На тебе все еще невидимый пояс. Нажми кнопку на пряжке и перенесешься 
...
Расправь плечи, расставь ноги и укроти кабана взглядом на 141. 
     ...
     Кабан приближается. Решай быстрей! ''', 260),
    TextStructure('''Пройдя по следам профа между холмами, ты неожиданно  оказываешься  на 
...
падаешь на 250. ''', 262),
    TextStructure('''Из последних сил ты доплываешь до берега, хватаясь за  ветки  кустов, 
...
монстр Зеленый Пупок. Внимание, монстр готовится к атаке! 
     ...
     Если же выстрелишь в него из лука, то на 195''', 263),
    TextStructure('''Согласен,  при  проливном  дожде,  ослепительных  вспышках  молний  и 
...
защитой деревьев на 263. ''', 265),
    TextStructure('''После того как вы с кабаном на два голоса  исполнили  "Ферму  старика 
...
споем еще. А теперь до свидания. Тебе по этой тропе к 73. ''', 266),
    TextStructure('''Надпись не обманула - ты прошел через дверь, но мгновенной смерти  не 
...
хоть, и с трудом, но все же читаешь очередную надпись: 
     ...
     Открывай же и смело иди на 119. ''', 267),
    TextStructure('''Едва ты удаляешься на несколько шагов, как до тебя  доносятся  глухие 
...
бросаешься в бой на 157. ''', 268),
    TextStructure('''Ты попал в шестиугольную комнатенку. Ну и росписи на стенах! Не иначе 
...
внимания на безвкусные росписи, огляди комнатенку. 
     ...
     Или на юг к 341. ''', 269),
    TextStructure('''Впереди  ты  слышишь  тяжелую  поступь,  и,  прежде   чем   успеваешь 
...
ногу. Не опасаясь прослыть трусом, беги от него! 
     ...
     Прямиком на 75. ''', 270),
    TextStructure('''От шлема ты избавляешься  без  проблем,  но  вскоре  выясняешь,  что, 
...
высоты прямиком на 280, поспешно встаешь и оглядываешься. ''', 272),
    TextStructure('''Ты оказываешься в небольшой пыльной  комнате  с  четырьмя  дверями  в 

дальней стене, на дверях цифры: I, II, III, IV. За спиной звучит гнусный голос 
...
вверх. Всхлипывая, ты отправляешься на 348. ''', 274),
    TextStructure('''Ты прав - на помощь нытиков рассчитывать не стоит. Едва между тобой и 
...
хватает тебя за ноги, подтаскивает к дереву, привязывает к стволу лианами. 
     ...
     Если желаешь знать, что дальше, смотри 70. ''', 275),
    TextStructure('''Что есть духу ты  несешься  по  коридору,  который  приводит  тебя  к 
...
задания, каждый из нас останется на своем месте. 
     ...
     Высади дверь и ты - на 95. ''', 276),
    TextStructure('''Уже третий час ты бредешь по дороге, вокруг - ни души. 
...
отправляйся к 290. ''', 277),
    TextStructure('''Дрожащий  язычок  пламени  зажигалки  все  ближе,  смех  злодея   все 
...
хлеща себя по бокам длиннющим хвостом, вновь приближается. 
     ...
     Отлично, тогда быстрее к 326. ''', 279),
    TextStructure('''Ты оказался в комнате без дверей и окон. Не бубни под нос проклятия в 
...
100. Если щит и короткий меч, то на 173. Решай живее! ''', 280),
    TextStructure(''' Пользуясь удивительными  возможностями  своей  давно  забытой  науки, 
...
дождь, комнату продувает пронизывающий ветер. Бр-р-р! 
     ...
     Решай быстрее, куда направишься. ''', 281),
    TextStructure('''Не слишком удачный ход! 
...
слабака на месте или подарить ему его никчемную жизнь? 
     ...
     Если решка - на 243. ''', 283),
    TextStructure('''Ты опять промахнулся, а Роббин Гут опять  попал.  Но  не  отчаивайся! 
...
воздух, а ты оказываешься на 184. 
     ...
     Или на 286. ''', 284),
    TextStructure('''С убийственным звуком дверь за тобой  захлопывается.  Не  царапай  ее 
...
100. Если щит и короткий меч, то на 173. Решай живей! ''', 285),
    TextStructure('''Опять промахнулся, а Роббин Гут опять попал! Ты проиграл поединок,  и 

не просто проиграл, что само по себе обидно, а проиграл всухую! 

     С перекошенным от злости лицом ты переносишься на 44. ''', 286),
    TextStructure('''Спастись бегством - не такое  уж  разумное  решение,  каким  казалось 
...
другое, более мудрое решение! ''', 287),
    TextStructure('''Тебя, не иначе, занесло  в  преисподнюю!  Быстрее  возвращайся  туда, 

откуда начал путь! ''', 288),
    TextStructure('''Ты попал, а соперник промахнулся! Счет стал два-один в  твою  пользу. 

Спокойно целься и стреляй, окажешься на 133 или на 343. ''', 289),
    TextStructure('''Ты  вовремя  замечаешь,  что  навстречу  тебе  идет  верзила  и  лихо 
...
седовласого старика. 
     ...
     Или, сделав вид, что не замечаешь его, пройдешь мимо к 154. ''', 290),
    TextStructure('''Похоже, невзгоды, перенесенные тобой на этой  планете,  действительно 

превратили тебя в идиота! 

     Быстрее вернись на 350 и хорошенько раскинь мозгами! ''', 291),
    TextStructure('''Ты совершенно прав, действительно, клиренс - расстояние между  низшей 

точкой корпуса автомобиля и дорогой. Получай  в  актив  еще  сто  очков  и 

двигай сразу на 229. ''', 292),
    TextStructure('''Заполненный  ржавыми  пыльными  механизмами  склад.  Обойдя  его,  ты 
...
обнаруживаешь две двери. 
     ...
     Решай быстрей, куда направишься. ''', 293),
    TextStructure('''Действительно ли твое лицо обдувает свежий ветерок, или ты принимаешь 
...
пока продолжай поиски безумного профа. 
     ...
     Или на запад к 264. ''', 294),
    TextStructure(''' Погруженная в багровый полумрак  комната  действует  тебе  на  нервы. 
...
Поспеши же отсюда. 
     ...
     Или на юг к 293. ''', 295),
    TextStructure('''От усталости ты едва не валишься с ног. Неудивительно,  ведь  умершие 
...
обошел комнату и отыскал три выхода. 
     ...
     Выбирайся отсюда! ''', 296),
    TextStructure('''Длинная комната, вдоль стен груды  неизвестных  тебе  предметов,  пол 
...
Шлепая но щиколотку в ледяной воде, ты обнаруживаешь две двери. 
     ...
     Выбирайся через любую. ''', 297),
    TextStructure('''Если ты ответил, что в 1492 году от рождества Христова Колумб  открыл 

Америку, отправляйся на 229. Если нет, считай себя уволенным  и  выбирайся 

как знаешь. ''', 298),
    TextStructure('''Одобрительно кивнув, дракон заявляет: 
...
тебя, извини, съем. Ну что, согласен? 
     ...
     Ты неохотно киваешь и оказываешься на 350. ''', 299),
    TextStructure('''Ты оказался в комнате, наполненной газом счастья.  Ты  смеешься,  как 
...
идиот, плачешь от счастья, бесцельно бродишь по кругу. 
     ...
     Быстрее выбирайся отсюда через любую из них. ''', 300),
    TextStructure('''Ты  карабкаешься,  карабкаешься,  карабкаешься  вверх,  пальцы   твои 
...
обрывается лестница. 
     ...
     Или предварительно на 271 снимешь кольчугу? ''', 301),
    TextStructure('''Твоя уловка сработала, лев прыгнул, ты вовремя отступил в сторону,  и 

он промахнулся. Но он вновь приближается и вновь готовится к прыжку!  Тебе 

самое время отпрыгнуть на 331. ''', 302),
    TextStructure('''Глазам не верю! Твоя идея сработала! Царь зверей свернулся  калачиком 
...
и кланяясь, гордо следуешь на 335. ''', 303),
    TextStructure('''Ты поудобней устраиваешься в кресле, нажимаешь кнопку и... 

     В полу открывается люк, кресло сбрасывает тебя  вниз,  и  ты  летишь, 

летишь, пока не достигаешь главы 93. ''', 304),
    TextStructure('''Глазам не верю! Твоя идея сработала!  Беспощадный  зверюга  свернулся 
...
гордо следуешь на 335. ''', 305),
    TextStructure('''Ты съезжаешь в темноте по скользкому каменному скату. Не  правда  ли, 
...
там уж выбирайся на песчаную косу 2. ''', 306),
    TextStructure('''С   внезапным   проворством   двадцатитонный   кабан    подпрыгивает, 
...
оказываешься на 309. ''', 307),
    TextStructure('''По тропинке мимо кустов, где ты сидишь, бредет колонна роботов. Их не 
...
случится дальше, узнаешь на 324. ''', 308),
    TextStructure('''Великолепно! Перед  тобой  поверженный  в  грязь  гигантским  копытом 
...
крючок, и... 
     ...
     Чем кончится дело, узнаешь на 338. ''', 309),
    TextStructure('''Не  слишком  удачный  прием!  Стражник  с  поблескивающим   в   лучах 
...
приходится по твоему шлему, и ты, оглушенный, падаешь на 79. ''', 310),
    TextStructure('''Ты с удовольствием наблюдаешь, как Роббин Гут, швырнув на землю  лук, 
...
тебе нужно? Этот вопрос разъяснится на 23. ''', 311),
    TextStructure('''Откуда я  знал,  что  так  выйдет?!  В  конце  концов  ты  сам  решил 
...
другое, более мудрое решение! ''', 312),
    TextStructure('''Склон холма оказывается весьма крутым. Ты, цепляясь за  пучки  травы, 
...
метров. 
     ...
     Что я говорил? Ты уже на вершине 245. ''', 313),
    TextStructure('''Фрукты растут высоко, с  земли  их  не  достать.  Ты  взбираешься  на 
...
шагаешь по тропинке к 113. ''', 314),
    TextStructure('''Беззаботно насвистывая и помахивая луком, ты идешь по тропе, усеянной 
...
привыкать, и ты, достав стрелу, смело поворачиваешь на 116. ''', 315),
    TextStructure('''Ты победил! 

     Ржавый робот на коленях молит тебя о пощаде: 

     - О, могуществе��ный незнакомец! Ты победил! И теперь можешь разрубить 
...
разрубишь его на части, ты - на 77. ''', 316),
    TextStructure('''Роботы, восторгаясь твоим мудрым решением, подпрыгивают от  восторга. 
...
Будут вкалывать на моей фабрике собачьих консервов! 
     ...
     Или, предоставив нытиков их собственной судьбе, отправишься на 268. ''', 317),
    TextStructure('''Над твоей головой безоблачное  голубое  небо,  под  ногами  желтый  в 
...
благодарность он оставит тебя в покое, то отправляйся на 152. 
     ...
     Если, дождавшись прыжка хищника, ты отскочишь в сторону, то на 183. ''', 318),
    TextStructure('''Раскинь еще раз мозгами, новобранец! 

     У тебя против всех преступников Эндсвилля всего лишь короткий меч. Не 

глупи, попроси у Сейди какого-нибудь оружия на 41. ''', 319),
    TextStructure('''Ничего хорошего не получилось! 
...
оказываешься на 316. ''', 320),
    TextStructure('''Ты  захлопываешь  дверь.  Как  раз  вовремя!  Башня  с  оглушительным 
...
лети к 326. ''', 321),
    TextStructure('''Ты рывком распахиваешь дверь и отступаешь в сторону.  На  саблезубого 
...
смело шагай на 188. ''', 322),
    TextStructure('''Тобой  безраздельно  овладевает  страх!  Ты  стоишь,   не   в   силах 
...
очаровашки-кабанихи"? Решай же! 
     ...
     Если же свинг, то на 52. ''', 323),
    TextStructure(''' Ты вскрикиваешь! Но не от боли, а от неожиданности. Ты  с  головы  до 
...
помогут в бою. ''', 324),
    TextStructure('''Звуки с каждой секундой  приближаются,  становятся  громче,  твои  же 
...
на 308. ''', 325),
    TextStructure('''Не дерись с хищником, используй с борьбе с ним мозги! 
...
подойдет ближе... 
     ...
     Пора! Двигай к 322. ''', 326),
    TextStructure('''Ты с трудом поворачиваешь голову птицы Рок вправо,  так,  чтобы  клюв 
...
распахиваешь дверь и попадаешь на 321. ''', 327),
    TextStructure('''Не огорчайся, новобранец, в конце концов не  можешь  же  ты  одержать 
...
порван, левый сапог натер ногу... 
     ...
     Тогда загляни на 56. ''', 328),
    TextStructure('''Хозяин удава, обыскав тебя, выбрасывает рубин, так и не разобравшись, 
...
обнаруживаешь, что оказался на 328. ''', 329),
    TextStructure(''' - Мудрое решение, - одобряет твой выбор герцог, сажает позади себя  в 
...
машину времени. Щелкни пальцами и перенесешься во времени на 80. ''', 330),
    TextStructure(''' Хищник вновь промахнулся. Но, согласен, хоть  он  и  слегка  неуклюж, 
...
зрачки хищника до самой 303. ''', 331),
    TextStructure('''Согласен, щекотать хищника - не слишком умная идея.  Животное  просто 

отшвырнуло тебя ударом лапищи и теперь, приблизившись, вновь  готовится  к 

прыжку. Самое время отпрыгнуть на 331. ''', 332),
    TextStructure('''Хотя и  основательно  поцарапавшись,  ты  все  же  влезаешь  в  узкий 
...
тоннель на 19. 
     ...
     Тем более, что выбора у тебя все равно нет. ''', 333),
    TextStructure('''Солнце жарит нестерпимо, ноги твои  поминутно  спотыкаются  о  грубые 
...
ну быстро через ту дверь в конце зала на 273. ''', 334),
    TextStructure('''Ты  вновь  в  комнате  с  четырьмя  дверями,  вооруженные   стражники 
...
арене. 
     ...
     Решай быстрей, куда направишься! ''', 335),
    TextStructure('''Слушай меня внимательно, новобранец! 
    Если ты нырнешь в кольчуге, то камнем пойдешь ко дну и,
     соответственно, уже никогда не станешь настоящим полевым агентом Спецкорпуса!
      Взвесь еще раз печальные последствия чуть было ни совершенного тобой
       опрометчивого поступка и двигай на 271. ''', 336),
    TextStructure('''Обойдя кресло, ты входишь в тоннель и двигаешься к свету. В полу  под 

твоими ногами распахивается люк, ты падаешь в него, и летишь, летишь, пока 

не достигаешь главы 93. ''', 337),
    TextStructure('''ПОЗДРАВЛЯЮ!!! 
...
Корпуса! 
     ...
     Ты изменил мир! Ты победитель! ''', 338),
    TextStructure('''Ты вновь на перекрестке. Вокруг ни души, дорогу спросить не  у  кого. 
...
Что ж, почеши в затылке и реши, куда направишься. 
     ...
     Если на запад, то на 129. ''', 339),
    TextStructure('''Ты идешь по тропе,  которая  петляет  среди  деревьев.  Ты  уже  было 
...
отправляйся за списком на 260. ''', 340),
    TextStructure('''Я так и знал: ничего не видно. Что, ты потерял дверь?!  Идиот,  зачем 

было ее закрывать? Ищи дверь на ощупь.  Еще-еще...  Нашел?  Твое  счастье. 

Теперь ступай на 269. ''', 341),
    TextStructure('''Промахнулся! А Роббин Гут? Роббин Гут попал!  Ты  проиграл  поединок. 

Хотя и не всухую, но все равно обидно! 

     С перекошенным от досады лицом ты переносишься на 44. ''', 342),
    TextStructure('''Ты попал, а Роббин Гут промахнулся! Победа! 

     Правда, не всухую, но все же победа! 

     Со счастливой улыбкой ты переносишься на 311. ''', 343),
    TextStructure('Ты опять ошибся. Двигай быстрей на 89.', 344),
    TextStructure('''Коридор был  слишком  узок.  Охранники  поймали  тебя,  выволокли  из 
...
вырублен, то я тоже ничего не видел. 
     ...
     Открывай быстрее глаза и, оказавшись на 339, выясняй, куда ты угодил. ''', 345),
    TextStructure('''Ты опять ошибся. Двигай быстрей на 89. ''', 346),
    TextStructure('''Чудище в негодовании рычит: 
...
произошло на планете Земля в 1492 году от рождества Христова? 
     ...
     Тогда отвечай и смотри 298. ''', 347),
    TextStructure('''Ты  вновь  в  комнате  с  четырьмя  дверями,  вооруженные   стражники 
...
одержишь победу. 
     ...
     Решай же быстрей, куда направишься! ''', 348),
    TextStructure('''Ну и дела! 

     Одумайся, новобранец! 

     Быстрее возвращайся туда, откуда явился! ''', 349),
    TextStructure('''Дракон задает первый вопрос: 
...
Гранта? 
     ...
     Если не знаешь ответа, то на 291. ''', 350),
     TextStructure('''Добро пожаловать! 
...
Корпуса. Слушай приказ! 
     ...
     НЕМЕДЛЕННО ОТПРАВЛЯЙСЯ К ТРИДЦАТОЙ ГЛАВЕ! 30 ''', 351),
    ];
}